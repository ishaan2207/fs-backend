...
const updateMessageRoute = require('./routes/updateMessage');

const createProfileInformationRoute = require('./routes/createProfileInformation');
...
app.use('/create-user', createProfileInformationRoute);
